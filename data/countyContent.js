...
function georgiaContent(countyName, county, s) {
  ...
  if (countyName === 'Cobb County') {
    ...
    metaTitle = `Macon-Bibb Wildlife Removal — Antebellum Macon, Mercer & Ocmulgee Corridor`;
    metaDescription = `Licensed wildlife removal in Bibb County, GA — Macon, Vineville, In-Town, Beall's Hill, Pleasant Hill. Antebellum chimney bat colonies, Ocmulgee raccoon work. Same-day service.`;
